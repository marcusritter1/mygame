...
class Menu:
    def __init__(self, screen, WIDTH, HEIGHT, FPS_COUNTER, REFRESH_RATE):
        self.screen = screen
        ...
        print("DEBUG REFRESH_RATE:", self.REFRESH_RATE)
    ...
    def draw(self):
        ...
        pygame.display.flip()
        self.clock.tick(self.REFRESH_RATE)  # Limit FPS to set system refresh rate
